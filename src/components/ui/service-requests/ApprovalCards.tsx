...
export function ApprovalCards({ requests, onApprove, onDeny, onDismiss }: ApprovalCardsProps) {
    ...
    return (
        <div className="relative mb-6">
            <div className="relative" style={{ minHeight: visibleRequests.length > 0 ? '140px' : '0' }}>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-shrink-0 flex items-center gap-2">
                                            <Button
                                                ...
                                                className="bg-pink-600 hover:bg-pink-700 text-white h-8 px-4"
                                            >
                                                Deny
                                            </Button>
                                            <div className="relative">
                                                ...
                                                <button
                                                    className="absolute -right-1 -top-1 flex items-center justify-center w-4 h-4 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
