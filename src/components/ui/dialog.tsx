...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "sticky top-0 z-10 flex flex-col space-y-1.5 text-center sm:text-left bg-background border-b border-gray-200 dark:border-gray-700 px-6 py-4",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "sticky bottom-0 z-10 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 bg-background border-t border-gray-200 dark:border-gray-700 px-6 py-4",
      className
    )}
    {...props}
  />
