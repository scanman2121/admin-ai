              ...
              <li className="mt-6">
                <div>
                 ...
                 <a
                   ...
                   className="group flex items-center justify-between rounded-md py-2 px-3 text-[13px] font-normal text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-50 transition-colors"
                 >
