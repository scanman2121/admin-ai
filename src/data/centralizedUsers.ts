...
export const centralizedUsers: CentralizedUser[] = [
  ...
  // Acme Inc - Tenant Company
  {
    id: "alice-cooper-acme",
    name: "Alice Cooper",
    initials: "AC",
    email: "alice.cooper@acmeinc.com",
    role: "admin",
    company: "Acme Inc",
    department: "Operations",
  ...
  {
    id: "robert-martinez-acme",
    name: "Robert Martinez",
    initials: "RM",
    email: "robert.martinez@acmeinc.com",
    role: "member",
    company: "Acme Inc",
    ...
    phone: "(555) 401-1002",
    buildings: ["Main Tower"],
    floorSuite: "Floor 5, Suite 518",
    hasMobileAccess: true,
    status: "active",
    badgeId: "ACME-RM-002",
    startDate: "2022-03-20",
    manager: "alice-cooper-acme",
    acsStatus: "active",
    canHostVisitors: true,
    preferredContactMethod: "email"
  },
  {
    id: "lisa-anderson-acme",
    name: "Lisa Anderson",
    initials: "LA",
    email: "lisa.anderson@acmeinc.com",
    role: "member",
    company: "Acme Inc",
  ...
  {
    id: "maria-gonzalez-acme",
    name: "Maria Gonzalez",
    initials: "MG",
    email: "maria.gonzalez@acmeinc.com",
    role: "member",
    company: "Acme Inc",
    department: "Finance",
