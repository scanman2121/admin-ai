...
export const serviceInventory: ServiceInventory[] = [
  {
    inventoryId: "INV-2023-001",
    dateCreated: "04/01/2023",
    propertyName: "Riverside Apartments",
    serviceType: "Badge",
    description: "New employee badge request",
    requestedBy: "Michael Johnson",
    status: "Completed",
    quantity: 1,
  },
  {
    inventoryId: "INV-2023-002",
    dateCreated: "04/03/2023",
    propertyName: "Oakwood Heights",
    serviceType: "Carpet Cleaning",
    description: "Deep carpet cleaning for Suite 205",
    requestedBy: "Sarah Williams",
    status: "In Progress",
    quantity: 1,
  },
  {
    inventoryId: "INV-2023-003",
    dateCreated: "04/05/2023",
    propertyName: "Parkview Condos",
    serviceType: "Badge",
    description: "Replacement badge for lost card",
    requestedBy: "David Chen",
    status: "Pending",
    quantity: 1,
  },
  {
    inventoryId: "INV-2023-004",
    dateCreated: "04/07/2023",
    propertyName: "Riverside Apartments",
    serviceType: "Window Cleaning",
    description: "Exterior window cleaning - floors 1-5",
    requestedBy: "Emily Rodriguez",
    status: "Completed",
    quantity: 5,
  },
  {
    inventoryId: "INV-2023-005",
    dateCreated: "04/10/2023",
    propertyName: "Oakwood Heights",
    serviceType: "Parking Pass",
    description: "Monthly parking pass renewal",
    requestedBy: "James Wilson",
    status: "Completed",
    quantity: 2,
  },
  {
    inventoryId: "INV-2023-006",
    dateCreated: "04/12/2023",
    propertyName: "Parkview Condos",
    serviceType: "Carpet Cleaning",
    description: "Spot cleaning for common area",
    requestedBy: "Lisa Anderson",
    status: "Pending",
    quantity: 1,
  },
  {
    inventoryId: "INV-2023-007",
    dateCreated: "04/14/2023",
    propertyName: "Riverside Apartments",
    serviceType: "Badge",
    description: "Contractor temporary access badge",
    requestedBy: "Robert Martinez",
    status: "In Progress",
    quantity: 3,
  },
  {
    inventoryId: "INV-2023-008",
    dateCreated: "04/16/2023",
    propertyName: "Oakwood Heights",
    serviceType: "Key Replacement",
...
export const tenantInvoices: TenantInvoice[] = [
  ...
  {
    invoiceId: "INV-T-2023-002",
    invoiceDate: "04/01/2023",
    propertyName: "Oakwood Heights",
    unitNumber: "205",
    tenantName: "Sarah Williams",
    description: "April 2023 Rent + Utilities",
    amountDue: 2350.00,
    dueDate: "04/15/2023",
    paymentStatus: "Paid",
  },
  {
    invoiceId: "INV-T-2023-003",
    invoiceDate: "04/01/2023",
    propertyName: "Parkview Condos",
    unitNumber: "512",
    tenantName: "David Chen",
  ...
  {
    invoiceId: "INV-T-2023-004",
    invoiceDate: "04/01/2023",
    propertyName: "Riverside Apartments",
    unitNumber: "107",
    tenantName: "Emily Rodriguez",
    description: "April 2023 Rent + Parking",
    amountDue: 1800.00,
    dueDate: "04/15/2023",
    paymentStatus: "Pending",
  },
  {
    invoiceId: "INV-T-2023-005",
    invoiceDate: "04/01/2023",
    propertyName: "Oakwood Heights",
    unitNumber: "310",
    tenantName: "James Wilson",
  ...
  {
    invoiceId: "INV-T-2023-007",
    invoiceDate: "05/01/2023",
    propertyName: "Parkview Condos",
    unitNumber: "512",
    tenantName: "David Chen",
    description: "May 2023 Rent + Late Fee",
    amountDue: 2200.00,
    dueDate: "05/15/2023",
    paymentStatus: "Pending",
  },
  {
    invoiceId: "INV-T-2023-008",
    invoiceDate: "05/01/2023",
    propertyName: "Oakwood Heights",
    unitNumber: "205",
    tenantName: "Sarah Williams",
    description: "May 2023 Rent + Utilities",
    amountDue: 2350.00,
    dueDate: "05/15/2023",
    paymentStatus: "Paid",
  },
