...
export const serviceInventory: ServiceInventory[] = [
  {
    ...
    serviceTypes: ["Badge Request", "New Employee Setup"],
  },
  {
    serviceId: "SVC-002",
  ...
  },
  {
    ...
    serviceTypes: ["Badge Request", "Contractor Access"],
  },
  {
    serviceId: "SVC-004",
    ...
    serviceTypes: ["Floor Cleaning", "Deep Clean"],
  },
  {
    serviceId: "SVC-005",
  ...
  },
  {
    ...
    serviceTypes: ["Room Setup", "Catering"],
  },
  {
    serviceId: "SVC-013",
...
export const tenantInvoices: TenantInvoice[] = [
  {
    ...
    property: "Riverside Apartments",
    tenantName: "Michael Johnson",
    invoiceType: "service_request",
    source: {
      type: "service_request",
      sourceId: "WO-ABC123",
      sourceName: "New Employee Badge Request",
      sourceDate: "03/28/2023",
      sourceStatus: "Completed",
      sourceRequestor: "Michael Johnson - TechCorp Solutions",
    },
    lineItems: [
      { id: "li-001", serviceId: "SVC-001", description: "Employee Badge", quantity: 1, unitPrice: 25.00, total: 25.00 },
    ],
    subtotal: 25.00,
    total: 25.00,
    dueDate: "04/15/2023",
  ...
  },
  {
    ...
    source: {
      type: "service_request",
      sourceId: "WO-DEF456",
      sourceName: "Deep Carpet Cleaning Request",
      sourceDate: "03/30/2023",
      sourceStatus: "Completed",
      sourceRequestor: "Sarah Williams - Global Tech",
    },
    lineItems: [
      { id: "li-002", serviceId: "SVC-004", description: "Deep Carpet Cleaning - Suite 205", quantity: 1, unitPrice: 350.00, total: 350.00 },
    ],
    subtotal: 350.00,
    total: 350.00,
    dueDate: "04/17/2023",
  ...
  },
  {
    ...
    source: {
      type: "service_request",
      sourceId: "WO-GHI789",
      sourceName: "Badge Replacement Request",
      sourceDate: "04/02/2023",
      sourceStatus: "Completed",
      sourceRequestor: "David Chen - Innovate Solutions",
    },
    lineItems: [
      { id: "li-003", serviceId: "SVC-002", description: "Replacement Badge", quantity: 1, unitPrice: 35.00, total: 35.00 },
    ],
    subtotal: 35.00,
    total: 35.00,
    dueDate: "04/19/2023",
  ...
  },
  {
    ...
    lineItems: [
      { id: "li-004", serviceId: "SVC-008", description: "Monthly Parking Pass", quantity: 1, unitPrice: 150.00, total: 150.00 },
    ],
    subtotal: 150.00,
    total: 150.00,
    dueDate: "04/21/2023",
  ...
  },
  {
    ...
    source: {
      type: "service_request",
      sourceId: "WO-JKL012",
      sourceName: "Key Replacement Request",
      sourceDate: "04/08/2023",
      sourceStatus: "Completed",
      sourceRequestor: "James Wilson - Tech Innovators",
    },
    lineItems: [
      { id: "li-005", serviceId: "SVC-010", description: "Key Replacement", quantity: 1, unitPrice: 45.00, total: 45.00 },
    ],
    subtotal: 45.00,
    total: 45.00,
    dueDate: "04/24/2023",
  ...
  },
  {
    ...
    source: {
      type: "service_request",
      sourceId: "WO-MNO345",
      sourceName: "Spot Cleaning Request",
      sourceDate: "04/10/2023",
      sourceStatus: "Cancelled",
      sourceRequestor: "Lisa Anderson - Acme Inc",
    },
    lineItems: [
      { id: "li-006", serviceId: "SVC-005", description: "Spot Cleaning", quantity: 1, unitPrice: 75.00, total: 75.00 },
    ],
    subtotal: 75.00,
    total: 75.00,
    dueDate: "04/26/2023",
    ...
    paymentMethod: null,
    paidDate: null,
    notes: "Voided - service request cancelled",
  },
  {
    ...
    source: {
      type: "service_request",
      sourceId: "WO-PQR678",
      sourceName: "Contractor Access Badges",
      sourceDate: "04/12/2023",
      sourceStatus: "In Progress",
      sourceRequestor: "Robert Martinez - Acme Inc",
    },
    lineItems: [
      { id: "li-007", serviceId: "SVC-003", description: "Temporary Access Badge", quantity: 3, unitPrice: 15.00, total: 45.00 },
    ],
    subtotal: 45.00,
    total: 45.00,
    dueDate: "04/28/2023",
  ...
  },
  {
    ...
    invoiceType: "manual",
    lineItems: [
      { id: "li-008", description: "Window Cleaning (Exterior) - Custom Quote", quantity: 1, unitPrice: 275.00, total: 275.00 },
    ],
    subtotal: 275.00,
    total: 275.00,
    dueDate: "04/30/2023",
    ...
    paymentMethod: null,
    paidDate: null,
    notes: "Custom quote for exterior window cleaning - 5 floors",
  },
  {
    ...
    invoiceType: "resource_booking",
    source: {
      type: "resource_booking",
      sourceId: "BK-001",
      sourceName: "Conference Room A - Full Day",
      sourceDate: "04/20/2023",
      sourceStatus: "Confirmed",
      sourceRequestor: "Maria Gonzalez - Global Finance",
    },
    lineItems: [
      { id: "li-009", serviceId: "SVC-012", description: "Conference Room Setup", quantity: 1, unitPrice: 150.00, total: 150.00 },
      { id: "li-010", description: "Catering - Lunch for 12", quantity: 1, unitPrice: 50.00, total: 50.00 },
    ],
    subtotal: 200.00,
    total: 200.00,
    dueDate: "05/02/2023",
  ...
  },
  {
    ...
    invoiceType: "event_registration",
    source: {
      type: "event_registration",
      sourceId: "EVT-001",
      sourceName: "Annual Tenant Appreciation Event",
      sourceDate: "05/15/2023",
      sourceStatus: "Registered",
      sourceRequestor: "Alice Cooper - Acme Inc",
    },
    lineItems: [
      { id: "li-011", serviceId: "SVC-009", description: "Daily Parking Pass", quantity: 5, unitPrice: 15.00, total: 75.00 },
    ],
    subtotal: 75.00,
    total: 75.00,
    dueDate: "05/04/2023",
    ...
    paymentMethod: null,
    paidDate: null,
    notes: "Parking passes for event attendees",
  },
]
